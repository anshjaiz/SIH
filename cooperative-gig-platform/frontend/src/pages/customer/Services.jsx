            ...
            <div key={svc._id} className="card hover:shadow-md transition-shadow">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <span className="badge badge-info text-xs">{svc.category}</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <div className="text-right text-gray-500">
                  <p>{svc.estimatedDuration} min</p>
                  <p className="text-xs">{svc.unit || 'per visit'}</p>
                </div>
              </div>
              {svc.emergencyAvailable && (
                <p className="text-xs text-orange-600 mt-2 font-medium">⚡ Emergency service available</p>
              )}
              <Link
